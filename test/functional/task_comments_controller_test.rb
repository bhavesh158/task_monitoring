...
class TaskCommentsControllerTest < ActionController::TestCase
  ...
  test "should create task_comment" do
    assert_difference('TaskComment.count') do
      post :create, task_comment: { message: @task_comment.message, task_id: @task_comment.task_id, user_id: @task_comment.user_id }
    end
  ...
  test "should update task_comment" do
    put :update, id: @task_comment, task_comment: { message: @task_comment.message, task_id: @task_comment.task_id, user_id: @task_comment.user_id }
    assert_redirected_to task_comment_path(assigns(:task_comment))
  end
